...
<template>
  <footer class="flex flex-col px-6 md:px-12 lg:px-32 mt-12">
    <div class="backgroundGradient relative overflow-hidden px-16 rounded-t-2xl bg-black">
      <div
...
.backgroundGradient {
  background: #000000;
  background: radial-gradient(circle, #000000 90%, #44d36f 100%);
}
</style>
