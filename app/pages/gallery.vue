...
<template>
  ...
  ]" :fit="0.8" fit-basis="auto" :min-radius="600" :segments="34" :drag-sensitivity="20" :enlarge-transition-ms="300"
    :grayscale="true" overlay-blur-color="#060010" image-border-radius="30px" opened-image-width="250px"
