...
const { questions, next, correct, actual, checkAnswer, onSelect, reset, resultMessage, quit, confirmDialogAnswer, confirmDialogVisible } = useEveryQuestions();
</script>
...
<template>
  <section>
    ...
    <h1>Quiz</h1>
    <p>Ez az everything quiz oldal.</p>
  </section>
